        ...
        <div class="row">
          ...
          <div class="col-md-4 mt-3">
            <div class="row">
              ...
              <div v-for="(amount, index) in [10, 20, 50, 100, 500, 1000, 3000]" :key="index" class="col-sm-6 mb-sm-3">
                <div 
                  class="card"
          ...
          <div class="col-md-5 mt-sm-3">
            ...
            <div class="mb-3 d-flex manual-add-btn">
              <button class="w-100 allBtn">Manual Add</button>
              <button class="w-100 allBtn ms-1">Proceed</button>
              <button class="w-100 allBtn ms-1">Coinpay</button>
            </div>
            <div class="mb-3">
          ...
          <div class="col-md-3"></div>
          <div class="col-md-9 mb-sm-3">
            <div class="col-12 bg-white rounded p-2 border mb-sm-3">
